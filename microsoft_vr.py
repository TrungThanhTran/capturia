...
if __name__ == "__main__":
    ...
    checkpoint = '/home/ubuntu/project/capturia/Meeting_Analysis/models/wavlm_large_finetune.pth'
    wav1 = '/home/ubuntu/project/capturia/Meeting_Analysis/test_data/downstreams_speaker_verification_vox1_data_David_Faustino_hn8GyCJIfLM_0000012.wav'
    wav2 = '/home/ubuntu/project/capturia/Meeting_Analysis/test_data/downstreams_speaker_verification_vox1_data_David_Faustino_xTOk1Jz-F_g_0000015.wav'
    verification(model_name,  wav1, wav2, use_gpu=False, checkpoint=None)
