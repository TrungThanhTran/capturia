...
st.set_page_config(page_title="SpeakerAssign",page_icon=image_logo)
footer="""
            <style>
...
if 'authentication_status' in st.session_state and st.session_state['authentication_status']:
    ...
    st.sidebar.header("Speaker Assignment")
    threshold = st.sidebar.slider('Threshold for speaker', 0.1, 1.0, 0.42)
    st.markdown("## Transcribe an audio with assigned speakers")
